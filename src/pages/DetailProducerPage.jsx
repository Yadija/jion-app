        ...
        <section className='z-1 relative mb-6 flex flex-grow flex-col gap-4 px-4 sm:px-6 md:px-12 lg:px-20'>
          <section className='flex gap-2 md:gap-4'>
            ...
            <section className='flex flex-col gap-2'>
              ...
              <p>
                ...
                {data.titles.map((item) => `${item.title}(${item.type})`).join(' | ')}
              </p>
              {data.favorites && (
                <p>
          ...
          <section>
            <article className='py-2'>
              ...
              <p>{data.about || 'No about information has been added to this title.'}</p>
            </article>
          </section>
...
export default DetailProducerPage;
