        ...
        <div className='background-color-blue w-72 p-4 shadow-xl'>
          <div>
            ...
            <button
              ...
              className='hover:text-color-blue hover:background-color-white absolute right-5 top-3 inline-flex h-8 w-8 items-center justify-center rounded-full text-2xl'
            >
              <RxCross1 />
